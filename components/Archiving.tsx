...
export default function Archiving() {
  return (
    <section id="section2" className="w-screen py-[80px] text-center">
      <SectionTitle title="ARCHIVING" />
      <div className="max-w-[1200px] mx-auto p-[24px] flex justify-center gap-20">
        <div className="max-w-[416px] p-[24px] flex flex-col items-start bg-black rounded-lg text-white">
          <Image
            src="/github-logo.svg"
            width={200}
            height={100}
          ...
          <p className="text-left text-lg">
            프로젝트 소스코드뿐 아니라 실습, 회고 등 모든 개발 관련 자료의
            클라우드처럼 사용하고 있습니다.
          </p>
        </div>
        <div className="max-w-[416px] p-[24px] flex flex-col items-start bg-black rounded-lg text-white">
          ...
          <p className="text-left text-lg">
            배포 단계까지 구현된 프로젝트 아카이브입니다. 앞으로 계속 추가 될
            계획입니다.
          </p>
        </div>
      </div>
